...
완벽해질 때까지 커뮤니티를 위해 '비공개로' 작업하지 마십시오. '일찍 릴리스, 자주 릴리스'의 이전 조언을 기억하십시오. 일반적으로 커뮤니케이션 채널을 확인하여 계획한 일이 이미 완료되었는지 확인하는 것뿐만 아니라 새로운 기능을 구축하거나 버그를 수정하려는 의도를 표시하여 커뮤니티(및 유지 관리자)가 기부금을 수락하는 가장 좋은 방법을 계획하는 데 도움이 될 수 있습니다. 커뮤니티는 귀하가 성공하기를 원하므로 귀하가 기여를 준비할 때 도움을 받는 것이 좋습니다.

#### 사용하는 사람과 리소스를 인정

당신이 구축하고 있는 다른 코드가 없는 오픈 소스에 대한 기여는 거의 없습니다. 기여에 사용한 다른 작업/도서관/개발을 인정하고 커뮤니티가 전체 프로젝트에 도움이 될 수 있는 이러한 리소스도 찾도록 도와주세요.

#### 커뮤니티에 환원

코드의 명백한 기여 외에도 조직에서 하드웨어 선물을 주선하거나(가능한 경우) 팀을 위한 모임을 주선하거나 단순히 새 구성원을 위한 질문에 답하는 데 시간을 보내는 것과 같이 커뮤니티에 되돌릴 수 있는 다른 방법을 고려하십시오. 당신 뒤에 오는 것.

코드는 확실히 중요하지만 진정으로 성공적인 오픈 소스 프로젝트는 '비코드' 기여에서도 번창합니다.

#### 출구 전략 계획

커뮤니티는 주기적입니다. 결국 귀하 및/또는 귀하의 조직은 커뮤니티를 종료해야 할 수 있습니다. 커뮤니티에 들어온 것보다 더 나은 상태로 커뮤니티를 떠나도록 노력하십시오. 이를 위해 할 수 있는 몇 가지 간단한 작업은 다음과 같습니다.
...
리더십과 통제 사이에는 큰 차이가 있음을 기억하는 것이 중요합니다. 대부분의 오픈 소스 커뮤니티는 프로젝트 방향을 과도하게 제어하려는 시도를 주저하지만 참가자가 주도권을 얻기 전에 가치 있는 기여를 할 것으로 기대합니다.
